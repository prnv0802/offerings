...
public class TestEDIReader extends TestBase{
    ...
    public void testEDIReader() throws InEDIException, TooManyListenersException, B2BNotFoundException,
        ...
        try
        {
            ...
            //edireader1.loadSchema("./sampleData/sefTest/855_Sample_SEF.sef");
            edireader1.parseFile("./sampleData/sampleData/AceHardware_850.x12");
