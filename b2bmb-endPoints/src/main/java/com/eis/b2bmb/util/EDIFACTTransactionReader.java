 ...
 */
public class EDIFACTTransactionReader {

    private static final Logger LOG = LoggerFactory.getLogger(EDIFACTTransactionReader.class);

    /**
     * Method that checks the 997 to see if the document was rejected.
     *
    ...
    public Iterator getTransactions(InputStream inputStream, BlobStore blobStore,
        ...
        EDIFACTTransactionListener eventListener = new   EDIFACTTransactionListener(edireader1,
        ...
        try {
            ...
            edireader1.setSchemaFormat(Edireader.schemaAutomatic);
