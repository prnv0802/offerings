...
public class as1 extends ConsoleDemo {
	...
	public void sendMessage(boolean sign, boolean encrypt, boolean compress,
			boolean requestMDN, boolean requestMDNSignature) throws InEDIException, java.io.IOException {
		...
		if (sign ) { 
			PFXFilePath = prompt("Specify the path to your PFX File",":","./testcert.pfx");
		...
		if (encrypt) {
			pubKey = prompt("Specify your partner certificate (.cer file)",":","./testcert.cer");
	...
	public void receiveMessage() throws InEDIException, java.io.IOException {
		String response;
	...
	public void processReceipt() throws InEDIException, java.io.IOException {
		String response;
